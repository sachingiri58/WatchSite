  ...
  return (
    <div
      ...
      style={{
        ...
        paddingLeft: "4rem"             // ✅ SPACE FROM LEFT
      }}
    >
      <ToastContainer />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={loginPageStyles.rememberMeContainer}>
              <div className={loginPageStyles.checkboxContainer}>
                <input type="checkbox"  id="remember" className={loginPageStyles.checkbox} checked={rememberMe}onChange={()=> setRememberMe(!rememberMe)}
                required />
              </div>
