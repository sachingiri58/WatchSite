...
import { Link, href, useLocation, useNavigate } from "react-router-dom";
...
<Clock className={navbarStyles.logoIcon}/>
  ...
  className={navbarStyles.logoLink}>
    <span style={navbarStyles.logoTextStyle} className={navbarStyles.logoText}>ChronoElite
...
<div className={navbarStyles.desktopNav}>
  ...
  return(
    ...
    className={`${navbarStyles.navItemBase} ${isActive ? navbarStyles.navItemActive
