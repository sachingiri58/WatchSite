...
import { Heart, Shield, Truck, WalletCards } from "lucide-react";
...
<div className={watchOfferBannerStyles.offerTag} style={watchOfferBannerStyles.playfairFont}>Limited Time Offer</div>
<h1 className={watchOfferBannerStyles.heading} style={watchOfferBannerStyles.playfairFont}> Premium{" "}
...
<p className={watchOfferBannerStyles.description}>
  Discover our exclusive selection of premium timepieces with special discounts upto 30% off. Elevate your style with precision  craftemanship.
</p>
<div className={watchOfferBannerStyles.countdownGrid}>
  {Object.entries(timeLeft).map(([unit, value]) =>(
    <div key={unit}
    className={watchOfferBannerStyles.countdownItem}>
      <div className={watchOfferBannerStyles.countdownValue}>{String(value).padStart(2,"0")}</div>
...
<div className={watchOfferBannerStyles.featuresContainer}>
  ...
  <div className={watchOfferBannerStyles.featureItem}>
    <Shield
     size={18} className={watchOfferBannerStyles.featureIcon}/>
 ...
 <div className={watchOfferBannerStyles.imageSection}>
  ...
  <div className={watchOfferBannerStyles.priceTag}>
    <div className={watchOfferBannerStyles.oldPrice}>₹899.90

    </div>
    <div className={watchOfferBannerStyles.newPrice}>₹629.99

</div>
<div className={watchOfferBannerStyles.discount}>Save 30%
